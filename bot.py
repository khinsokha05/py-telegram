...
def setup_application():
    """Build and return the application instance for flask_app.py"""
    Config.validate()
...
# THIS IS THE CRITICAL LINE: flask_app.py looks for this name
main_application = setup_application()

if __name__ == '__main__':
    # This only runs if you run 'python bot.py' manually in a console
    print("Starting local polling for testing...")
    main_application.run_polling(drop_pending_updates=True)